 ...
 */
class ClientsDataTable extends PlatformDataTable
{
    const SHOW_URL_ROUTE = 'clients';
              ...
              <b class='wid-40'>BDM : </b><span class=''>Poul Hasson</span>
                   ...
                   <div class='col-md-2 pad-top-bot'>
                    <div class='sales-bx broder-none'>
                     <p>
                   <a href='clients/destroy/$user->id'>&nbsp;&nbsp;&nbsp;<i class='fa fa-times'></i></b>&nbsp;<span>Delete Setting</span></a>
                    <p>
                    <p>
