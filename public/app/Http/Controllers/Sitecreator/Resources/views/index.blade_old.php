...
<div class="az-content-body">
	...
	<div id="vvveb-builder">
				...
				<div id="top-panel">
					<img src="i/mg/logo.png" alt="Vvveb" class="float-left" id="logo">
					...
					<div class="btn-group float-left" role="group">
					  <button class="btn btn-light" title="Toggle file manager" id="toggle-file-manager-btn" data-vvveb-action="toggleFileManager" data-toggle="button" aria-pressed="false">
						  <img src="/js/builder/icons/file-manager-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle left column" id="toggle-left-column-btn" data-vvveb-action="toggleLeftColumn" data-toggle="button" aria-pressed="false">
						  <img src="/js/builder/icons/left-column-layout.svg" width="20px" height="20px">
					  </button>
					  ...
					  <button class="btn btn-light" title="Toggle right column" id="toggle-right-column-btn" data-vvveb-action="toggleRightColumn" data-toggle="button" aria-pressed="false">
						  <img src="/js/builder/icons/right-column-layout.svg" width="20px" height="20px">
					  </button>
					</div>
...
<script src="/js/builder/components-bootstrap4.js"></script>
...
<link href="/js/codemirror/theme/material.css" rel="stylesheet"/>
<script src="/js/codemirror/lib/codemirror.js"></script>
<script src="/js/codemirror/lib/xml.js"></script>
<script src="/js/codemirror/lib/formatting.js"></script>
