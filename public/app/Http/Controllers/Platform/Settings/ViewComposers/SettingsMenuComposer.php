...
class SettingsMenuComposer
{
    ...
    public function compose(View $view)
    {
        ...
        if($user->hasPermissionTo('settings.access')) {
            $settingsMenu->add(Link::to(route('settings.accounts.index'), trans('settings::settings.menu.accounts')));
        ...
        $settingsMenu->add(Link::to(route('settings.account_settings'), trans('settings::settings.menu.account')));
        if($user->hasPermissionTo('settings.access')) {
