		...
		data: [
			{
				...
				type: "pie",
				dataPoints: [
					{ y: 342373.50, name:"Resignation", color: "#393f63" },
					{ y: 348421.50, name:"Absconding", color: "#e5d8b0" },
					{ y: 553455.00, name:"ATL", color: "#ffb367" }					
				]
			}
		]
	});
		...
		data: [
			{
				...
				type: "spline",
				dataPoints: [
					{ x: new Date("1 Jan 2015"), y: 4 },
					{ x: new Date("1 Feb 2015"), y: 8 },
					{ x: new Date("1 Mar 2015"), y: 12 },
					{ x: new Date("1 Apr 2015"), y: 10 },
					{ x: new Date("1 May 2015"), y: 6 },
					{ x: new Date("1 Jun 2015"), y: 11 },
					{ x: new Date("1 Jul 2015"), y: 13 },
					{ x: new Date("1 Aug 2015"), y: 1 },
					{ x: new Date("1 Sep 2015"), y: 22 },
					{ x: new Date("1 Oct 2015"), y: 15 },
					{ x: new Date("1 Nov 2015"), y: 15 },
					{ x: new Date("1 Dec 2015"), y: 17 }
				]
			}
		]
	});
