...
<a href="/sales-agents/create"><i class="fa fa-user" aria-hidden="true"> +Add Sale Agents</i></a>
...
<div class="form-popup" id="myForm">
  <form action="{{ url('/sales-agents/updateedit') }}" class="form-container" method="post">
    @csrf
...
{ 
  ...
  $.ajax({
    type: 'POST',
    url: "{{url('sales-agents/updatestatus')}}",
