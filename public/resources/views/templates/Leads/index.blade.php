...
<a href="/leads/create"><i class="fa fa-user" aria-hidden="true"> +Add leads</i></a>
...
<div class="form-popup" id="myForm">
 <form action="{{ url('/leads/updateedit') }}" class="form-container" method="post">
    @csrf
   <center><img src='/profileimage/1c791561be984c634024342af3a39724.png' alt=''><center><br><br>
    ...
    <input type="text" placeholder="email"  id="mobile" name="mobile"value="" >
    <label for="email"><b>office_phone</b></label>
    <input type="text" placeholder="email"  id="phone" name="phone"value="" >
