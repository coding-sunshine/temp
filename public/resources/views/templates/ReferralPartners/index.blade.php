...
<a href="/referral-partners/create"><i class="fa fa-user" aria-hidden="true"> +Add Referral Partner</i></a>
...
<div class="row top-filter">
  ...
  <form action="{{ url('/referral-partners/updateedit') }}" class="form-container" method="post">
    @csrf
...
// alert(name);
  ...
  $.ajax({
    type: 'POST',
    url: "{{url('referral-partners/Update')}}",
...
{ 
  ...
  $.ajax({
    type: 'POST',
    url: "{{url('referral-partners/updatestatus')}}",
