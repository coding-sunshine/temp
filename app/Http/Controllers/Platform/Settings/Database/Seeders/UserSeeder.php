...
class UserSeeder extends Seeder
{
    ...
    private static $_GROUPS = [
        ['id' => 1, 'name' => 'Marketing Group', 'account_id' => 1],
        ['id' => 2, 'name' => 'Support Group', 'account_id' => 1],
        ['id' => 3, 'name' => 'Service Group', 'account_id' => 1],
        ['id' => 4, 'name' => 'Work Group', 'account_id' => 2],
        ['id' => 5, 'name' => 'Support Team', 'account_id' => 2],
        ['id' => 6, 'name' => 'Assault Team', 'account_id' => 2]
    ];
    ...
    private static $firstAccountUsers = [
        [
            'id' => 2,
    ...
    private static $secondAccountUsers = [
        [
            'id' => 4,
    ...
    private function addAccountUsers()
    {
        foreach (self::$firstAccountUsers as $user) {
        ...
        foreach (self::$secondAccountUsers as $user) {
            $user['password'] = \Illuminate\Support\Facades\Hash::make('admin');
            $user['created_at'] = \Carbon\Carbon::now();
            $user['updated_at'] = \Carbon\Carbon::now();
            $user['account_id'] = 2;
