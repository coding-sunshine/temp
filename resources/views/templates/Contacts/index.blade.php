...
<div class="body">
<div class="col-sm-12">
<a href="/contacts/create"><i class="fa fa-user" aria-hidden="true"> +Add contacts</i></a>
...
<div class="form-popup" id="myForm">
  <form action="{{ url('/contacts/updateedit') }}" class="form-container" method="post">
    @csrf
