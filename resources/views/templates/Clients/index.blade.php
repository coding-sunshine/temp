...
<div class="body">
<div class="col-sm-12">
<a href="/clients/create"><i class="fa fa-user" aria-hidden="true"> +Add Client</i></a>
...
<div class="row top-filter">
 ...
 <div class="form-popup" id="myForm">
  <form action="{{ url('/clients/updateedit') }}" class="form-container" method="post">
    @csrf
