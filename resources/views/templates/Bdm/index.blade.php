...
<a href="/bdm/create"><i class="fa fa-user" aria-hidden="true"> +Add BDM</i></a>
...
<div class="form-popup" id="myForm">
  <form action="{{ url('/bdm/updateedit') }}" class="form-container" method="post">
    @csrf
