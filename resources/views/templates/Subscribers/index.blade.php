...
<a href="/subscribers/create"><i class="fa fa-user" aria-hidden="true"> +Add Subscriber</i></a>
...
<div class="row top-filter">
 ...
 <div class="form-popup" id="myForm">
  <form action="{{ url('/subscribers/updateedit') }}" class="form-container" method="post">
    @csrf
...
{ 
  ...
  $.ajax({
    type: 'POST',
    url: "{{url('subscribers/updatestatus')}}",
