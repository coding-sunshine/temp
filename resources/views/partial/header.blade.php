    ...
    <div class="container-fluid">
        ...
        <div class="az-header-right">
            ...
            <div class="dropdown az-profile-menu">
                <a href="" class="az-img-user"><img src="{{ asset('/image/avatars/male-1.png') }}" alt=""></a>
                <div class="dropdown-menu">
                    ...
                    <div class="az-header-profile">
                        ...
                        <!-- <img src="{{URL::to('public/profileimage').'/'.Auth::user()->profile_image}}" alt=""> -->
                    ...
                    <a href="" class="dropdown-item"><i class="typcn typcn-cog-outline"></i> Account Settings</a>
                        <a href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" class="dropdown-item"><i class="typcn typcn-power-outline"></i> Sign Out</a>
